...
// Get from console
// =================================================
#define AWS_IOT_MQTT_HOST              "a28z0eh8rmhoam.iot.us-east-2.amazonaws" ///< Customer specific MQTT HOST. The same will be used for Thing Shadow
...
#define AWS_IOT_CERTIFICATE_FILENAME   "a40f84c69e-certificate.pem" ///< device signed certificate file name
#define AWS_IOT_PRIVATE_KEY_FILENAME   "a40f84c69e-private.pem" ///< Device private key filename
// =================================================
